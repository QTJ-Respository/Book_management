...
public class Administrators {
    ...
    private int admins_state;//状态

    public Administrators() {
    }

    public Administrators(int admins_no, String admins_name, int admins_sex, int admins_age, String admins_email, String admins_tel, String admins_address, String admins_ID, int admins_state) {
